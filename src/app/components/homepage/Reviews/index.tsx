  ...
  return (
    <section className="overflow-hidden">
      ...
      >
        ...
        >
          <div className="relative flex items-center justify-between max-w-frame mx-auto mb-6 md:mb-10 px-4 xl:px-0">
  <motion.h2
    ...
    className={cn([
      ...
      "text-[32px] leading-[36px] md:text-5xl capitalize mx-auto text-center", // Added mx-auto and text-center
    ])}
  >
    OUR HAPPY CUSTOMERS
  </motion.h2>
